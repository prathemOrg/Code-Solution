...
namespace CodeSolution
{
    ...
    partial void DeleteVote(Vote instance);
		...
		public CodeSolutionDataContext() : 
				base(global::CodeSolution.Properties.Settings.Default.CodeSolutionConnectionString2, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnProblemStatusChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ProblemStatus", DbType="VarChar(50)")]
